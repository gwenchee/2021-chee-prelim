\begin{frame}
    \frametitle{Progress}
    \begin{itemize}
        \item Scope I: AHTR Model Development for the FHR Benchmark
    \end{itemize}
    \vspace{-0.8cm}
    \begin{figure}[]
        \centering
...
\begin{frame}
    \frametitle{Progress}
    \begin{itemize}
        \item Scope II: ROLLO Development and AHTR Optimization Demonstration
    \end{itemize}
    \vspace{-0.8cm}
    \begin{figure}[]
        \centering
        ...
        \begin{tikzpicture}[node distance=1.2cm,auto,>=latex']
            ...
            {\textbf{ROLLO v1.0 Single Objective Problems}};
            \node [oblock] (d) [right of=c, xshift=2.3cm] 
            {\textbf{ROLLO v1.0 Multi Objective Problems}};
