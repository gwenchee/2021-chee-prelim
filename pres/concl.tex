\begin{frame}
    ...
    \begin{figure}[]
        ...
        \begin{tikzpicture}[node distance=3.5cm,auto,>=latex']
            ...
            \node [noblock] (e) [above of=a, yshift=-2.3cm] {Stage 1-1};
            \node [noblock] (e) [above of=b, yshift=-2.3cm] {Stage 1-2};
            \node [noblock] (e) [above of=c, yshift=-2.3cm] {Stage 1-3};
            \node [noblock] (e) [above of=d, yshift=-2.3cm] {Stage 1-4};
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            evolutionary algorithm optimization to reactor design 
