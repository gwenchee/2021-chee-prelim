\begin{frame}
    ...
    \begin{itemize}
      \item Energy use and production contribute $\frac{2}{3}$ of Greenhouse Gas emissions
...
\begin{frame}
  ...
  \end{block}
  \begin{figure}[htbp!]
    \includegraphics[height=2.6cm]{figures/msr}
    \hspace{1cm}
    \includegraphics[height=2.6cm]{figures/vhtr}
\end{figure}
\end{frame}
\begin{frame}
