...
\begin{itemize}
    ...
    file.
    \item Open-source: I utilize a well-documented, open-source evolutionary algorithm 
    Python package to drive the optimization process, and established 
    ...
    to create an optimization tool for easy leveraging of evolutionary algorithms 
...
Figure \ref{fig:genetic_alg} from Chapter \ref{chap:lit-review} outlines an 
...
file, initializes the \gls{DEAP} genetic algorithm hyperparameters and operators, 
and finally runs the genetic algorithm following the flow chart in Figure 
\ref{fig:genetic_alg_nuclear}, in which the nuclear software evaluates each 
individual's fitness. 

In the subsequent sections, I describe the evolutionary algorithm software 
