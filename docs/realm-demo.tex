...
couple Moltres with \gls{REALM} to do \gls{AHTR} multiphysics optimization. 

The benefits of Moltres over other multiphysics codes, RELAP5 and NESTLE 
...
In the next section, I use the continuous energy and spatial OpenMC simulation 
to generate multi-group cross section data defined over discretized energy groups 
...
I then compare $k_{eff}$ for the continuous and multi-group simulations to 
determine if the energy and spatial homogenization used are acceptable. 
