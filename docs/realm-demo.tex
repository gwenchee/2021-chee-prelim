...
the proposed simulations to optimize these other parameters. 
...
energy and spatial simulation and the spatial and energy homogenized simulation. 
...
the continuous energy and space simulation. 
The minimal keff difference assures that I can use these homogenizations when 
