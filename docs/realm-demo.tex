...
or accurately. 
Finding a good set of hyperparameters requires trial and error. 

I used random sampling with a coarse-to-fine sampling scheme, whose advantages 
I previously discussed in Section \ref{sec:balance} to perform the hyperparameter search. 
...
For each experiment, I hold the number of OpenMC evaluations constant at 1000. 
