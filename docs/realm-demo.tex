...
The straightened AHTR fuel slab simulations in this section use the \gls{TRISO} 
...
There 26pcm difference between $k_{eff}$ values are within both uncertainty values, 
