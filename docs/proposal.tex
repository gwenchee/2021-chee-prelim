...
For preliminary work, I participated in Phase I-A and I-B of the \gls{OECD} 
\gls{NEA}'s \gls{FHR} benchmarking exercise. 
...
Phase I-C of the \gls{FHR} benchmark and set up Moltres simulations to model 
