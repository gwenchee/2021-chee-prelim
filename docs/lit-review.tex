...
Thus, I begin this literature review with an overview of the \gls{FHR} concept, 
...
The benchmark plans to have three phases, starting from a single fuel assembly
...
Therefore, in the proposed PhD scope, the stochastic evolutionary algorithm
...
for a given objective function with a much smaller set of constraints
\cite{sobes_artificial_2020}. 
...
\begin{enumerate}
    ...
    \item tuse probabilistic transition rules, not deterministic rules
\end{enumerate}
