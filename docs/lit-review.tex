...
The selection operator selects good individuals, while the crossover operator 
recombines together good individuals to hopefully form a better individual, 
and the mutation operator alters individuals to hopefully create a better 
individual \cite{deb_multi-objective_2001}. 
