...
\begin{figure}[]
    \centering
    \includegraphics[width=0.8\linewidth]{ornl-triso-print.png} 
...
Many of the materials and fabrication methods discussed above are also applicable 
...
\label{sec:opt}
The practice of nuclear reactor optimization began with the conception of 
nuclear reactors. 
...
high breeding of $^{233}$U and $^{239}$Pu in desired power peaking limits and
