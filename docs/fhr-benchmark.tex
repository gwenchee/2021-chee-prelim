...
factor for depletion of cases 1B, 4B, and 7B. 
\begin{figure}[]
    \centering
...
Case 1B's k-eff steadily decreases until it reaches 0.967845 at final 70 GWd/tU 
burnup. 
Case 4B includes burnable poisons resulting in a lower initial k-eff. 
It's k-eff decreases at a slower rate at the beginning due to the presence 
of the burnable poisons which decreases flux in the core. 
