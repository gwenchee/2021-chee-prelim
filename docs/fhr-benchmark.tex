...
\label{sec:phase1}
The \gls{FHR} benchmark Phase I consists of two subphases.
First, a steady-state 2D model (Phase I-A) and depletion of one \gls{FHR} fuel 
assembly (Phase I-B).
...
results with other codes in the benchmark, I converted flux to 
...
\begin{align}
    ...
    r_f &= \mbox{radius of fuel kernel within TRISO particle} \nonumber\\
...
The \gls{UIUC} participated in the benchmark with the OpenMC Monte Carlo code 
\cite{romano_openmc_2013} and the ENDF/B-VII.1 material library 
\cite{chadwick_endf/b-vii.1_2011}.
The \gls{UIUC} team consists of myself and my advisor, Dr. Kathryn Huff. 
I contributed Methodology, Software, Validation, Formal Analysis, and 
Visualization, while Dr. Huff contributed Resources, Supervision, and Funding 
acquisition.
...
utilization brought about by self-shielding. 
It also demonstrates that an increase in fuel packing fraction does not always 
correspond with an increased $k_{eff}$. 
