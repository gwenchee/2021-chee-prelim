...
\gls{FHR} benchmark for the \gls{AHTR} design \cite{noauthor_fluoride_nodate}. 
...
More details about the \gls{AHTR} design and the history of \gls{FHR} modeling 
efforts leading up to the benchmark can be found in Section \ref{sec:fhr}. 
...
and cases in the \gls{FHR} benchmark, and reported that standard deviation 
...
Figure \ref{fig:phase1a-d} shows average neutron flux in the fuel element in 
...
rod region of the fuel element.  
...
Spectrum becomes faster for case 6a and case 7a due to more heavy metal loading 
