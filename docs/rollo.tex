...
\begin{itemize}
    ...
    either the \texttt{multiprocessing} or \texttt{mpi4py} Python packages 
    \cite{dalcin_mpi_2008}.
...
input file template. 
\gls{ROLLO} utilizes jinja2 templating to insert the control variable values into the 
\texttt{input\_script}. 
...
multiprocessing$\_$on$\_$dill Python module to run ROLLO's nuclear software 
...
\texttt{k} value of 15 and \texttt{tournsize} value of 5. 
...
\subsection{Running ROLLO in Parallel}
