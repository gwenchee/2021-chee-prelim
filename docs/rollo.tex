...
\begin{itemize}
    ...
    either the \texttt{multiprocessing\_on\_dill} or \texttt{mpi4py} Python packages 
...
In the \gls{ROLLO} Github repository \cite{chee_arfcrollo_2021}, I include a tests 
...
\noindent
\texttt{rollo -i <input file name> -c <checkpoint file name>}
